...
# Configurar tkinter para no mostrar la ventana principal
Tk().withdraw()

# Abrir un cuadro de diálogo de explorador de archivos
file_path = askopenfilename(title="Selecciona el archivo .docx", filetypes=[("Word files", "*.docx")])
...
# Formar el nuevo nombre del archivo exportado
output_file_name = f"Factura {file_name}.xlsx"

# Obtener el directorio del archivo seleccionado
output_directory = os.path.dirname(file_path)

# Guardar el DataFrame limpio en un archivo Excel en el mismo directorio
